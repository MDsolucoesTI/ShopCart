...
let modelsJson = [
    ...
    {id:2, name:'Focke Wulf Fw190 A5', img:'img/Fw190A5.png', price:[80.00, 150.00, 200.00], sizes:['1/144', '1/48', '1/32'], description:'Caça de motor em estrela da Luftwaffe, temido em médias e baixas altitudes'},
    {id:3, name:'Ki 61 - Hien', img:'img/Ki61Hien.png', price:[100.00, 150.00, 280.00], sizes:['1/72', '1/48', '1/24'], description:'Caça fabricado pela Kawasaki para o exercito japones, com motor em linha'},
